...
export class ScheduleTopicExamResponse {
   async startTopicExam(
    ...
    try {
      ...
      const response = await CapacitorHttp.request({
        method: 'POST',
        url: 'https://www.abacustrainer.com/apicalls/Index/startScheduleTopicExam',
        headers: {
  ...
  async submitAllocatedTopicExam(
    ...
    try {
      ...
      const response: HttpResponse = await CapacitorHttp.request({
        method: 'POST',
        url: 'https://www.abacustrainer.com/apicalls/Index/submitScheduleTopicExam',
        headers: {
          'Content-Type': 'application/x-www-form-urlencoded'
        },
        data: body.toString()
