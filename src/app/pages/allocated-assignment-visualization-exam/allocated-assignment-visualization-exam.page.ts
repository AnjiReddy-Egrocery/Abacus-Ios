...
@Component({
  selector: 'app-allocated-assignment-visualization-exam',
   standalone: true,
    imports: [IonicModule, FormsModule, CommonModule],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './allocated-assignment-visualization-exam.page.html',
  styleUrls: ['./allocated-assignment-visualization-exam.page.scss'],
})
