...
@Component({
  selector: 'app-schedules-assignment-exam-result',
   standalone: true,
    imports: [IonicModule, FormsModule, CommonModule,  BaseChartDirective],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './schedules-assignment-exam-result.page.html',
  styleUrls: ['./schedules-assignment-exam-result.page.scss'],
})
export class SchedulesAssignmentExamResultPage implements OnInit {
topicName: string = '';
  totalTime: string = '';
  questions: any[] = [];
  answers: string[] = [];
