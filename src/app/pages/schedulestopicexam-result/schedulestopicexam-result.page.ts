...
@Component({
  selector: 'app-schedulestopicexam-result',
   standalone: true,
    imports: [IonicModule, FormsModule, CommonModule,  BaseChartDirective],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './schedulestopicexam-result.page.html',
  styleUrls: ['./schedulestopicexam-result.page.scss'],
})
export class SchedulestopicexamResultPage implements OnInit {
