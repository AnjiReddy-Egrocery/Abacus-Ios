...
import { ScheduleAssignmentExamResponse } from 'src/app/services/schedule-assignment-exam-response';

@Component({
  selector: 'app-schedules-assignment-visualization-exam',
  standalone: true,
    imports: [IonicModule, FormsModule, CommonModule],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './schedules-assignment-visualization-exam.page.html',
  styleUrls: ['./schedules-assignment-visualization-exam.page.scss'],
})
export class SchedulesAssignmentVisualizationExamPage implements OnInit {
...
private examService:ScheduleAssignmentExamResponse,
...
await alert.present();
  ...
  console.log("questionData:", questionData);
    ...
    this.router.navigate(['/schedules-assignment-visualization-exam-result'], {
      state: {
