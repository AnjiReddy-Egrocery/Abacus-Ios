...
@Component({
  selector: 'app-schedules-assignment-exam',
   standalone: true,
    imports: [IonicModule, FormsModule, CommonModule],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './schedules-assignment-exam.page.html',
  styleUrls: ['./schedules-assignment-exam.page.scss'],
})
export class SchedulesAssignmentExamPage implements OnInit {
...
await alert.present();
  ...
  console.log("questionData:", questionData);
    ...
    this.router.navigate(['/schedules-assignment-exam-result'], {
      state: {
