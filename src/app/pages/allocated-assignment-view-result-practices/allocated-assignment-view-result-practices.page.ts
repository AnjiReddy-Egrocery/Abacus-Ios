...
@Component({
  ...
  templateUrl: './allocated-assignment-view-result-practices.page.html',
  styleUrls: ['./allocated-assignment-view-result-practices.page.scss'],
})
export class AllocatedAssignmentViewResultPracticesPage implements OnInit {
topicName: string = '';
  totalTime: string = '';
