...
@Component({
  selector: 'app-allocated-topic-visualization-result-page',
  standalone: true,
    imports: [IonicModule, FormsModule, CommonModule,  BaseChartDirective],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './allocated-topic-visualization-result-page.page.html',
  styleUrls: ['./allocated-topic-visualization-result-page.page.scss'],
})
export class AllocatedTopicVisualizationResultPagePage implements OnInit {
