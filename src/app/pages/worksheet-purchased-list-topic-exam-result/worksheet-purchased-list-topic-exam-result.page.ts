...
@Component({
  selector: 'app-worksheet-purchased-list-topic-exam-result',
   standalone: true,
    imports: [IonicModule, FormsModule, CommonModule,  BaseChartDirective],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './worksheet-purchased-list-topic-exam-result.page.html',
  styleUrls: ['./worksheet-purchased-list-topic-exam-result.page.scss'],
})
export class WorksheetPurchasedListTopicExamResultPage implements OnInit {
topicName: string = '';
