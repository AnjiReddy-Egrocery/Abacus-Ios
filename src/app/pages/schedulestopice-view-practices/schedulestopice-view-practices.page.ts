...
import { ScheduleTopicViewResponse } from 'src/app/services/schedule-topic-view-response';

@Component({
  selector: 'app-schedulestopice-view-practices',
   standalone: true,
    imports: [IonicModule, FormsModule, CommonModule],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './schedulestopice-view-practices.page.html',
  styleUrls: ['./schedulestopice-view-practices.page.scss'],
})
export class SchedulestopiceViewPracticesPage implements OnInit {
studentId: string='';
  topicId: string = '';
  ...
  constructor(
    ...
    private topicService: ScheduleTopicViewResponse,
  ...
  openViewResult(practice: AllocatedPractice) {
    this.router.navigate(['/schedulestopic-view-practices-result'], {
      queryParams: {
