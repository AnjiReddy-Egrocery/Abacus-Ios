...
@Component({
  selector: 'app-allocated-assignment-visualization-result-page',
   standalone: true,
    imports: [IonicModule, FormsModule, CommonModule,  BaseChartDirective],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './allocated-assignment-visualization-result-page.page.html',
  styleUrls: ['./allocated-assignment-visualization-result-page.page.scss'],
})
export class AllocatedAssignmentVisualizationResultPagePage implements OnInit {
