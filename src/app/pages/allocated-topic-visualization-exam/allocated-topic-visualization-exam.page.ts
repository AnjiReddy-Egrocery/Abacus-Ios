...
@Component({
  ...
  templateUrl: './allocated-topic-visualization-exam.page.html',
  styleUrls: ['./allocated-topic-visualization-exam.page.scss'],
})
export class AllocatedTopicVisualizationExamPage implements OnInit {
...
await alert.present();
  ...
  console.log("questionData:", questionData);
    ...
    this.router.navigate(['/allocated-topic-visualization-result-page'], {
      state: {
