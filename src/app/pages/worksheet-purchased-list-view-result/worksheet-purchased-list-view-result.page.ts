...
@Component({
  ...
  templateUrl: './worksheet-purchased-list-view-result.page.html',
  styleUrls: ['./worksheet-purchased-list-view-result.page.scss'],
})
export class WorksheetPurchasedListViewResultPage implements OnInit {
