...
@Component({
  ...
  templateUrl: './allocated-view-topic-result-practices.page.html',
  styleUrls: ['./allocated-view-topic-result-practices.page.scss'],
})
export class AllocatedViewTopicResultPracticesPage implements OnInit {
topicName: string = '';
  totalTime: string = '';
