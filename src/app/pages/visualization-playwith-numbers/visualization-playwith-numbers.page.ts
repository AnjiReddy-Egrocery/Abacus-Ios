...
@Component({
  selector: 'app-visualization-playwith-numbers',
   standalone: true,
      imports: [IonicModule, FormsModule, CommonModule],
        schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './visualization-playwith-numbers.page.html',
  styleUrls: ['./visualization-playwith-numbers.page.scss'],
})
...
levels = ['Level-1', 'Level-2', 'Level-3', 'Level-4', 'Level-5'];
 ...
 async startNumberGame() {
  ...
  this.router.navigate(['/visualization-game-levels', levelNumber]);
}
