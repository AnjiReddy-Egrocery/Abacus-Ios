...
@Component({
  selector: 'app-schedules-assignment-visualization-exam-result',
  
   standalone: true,
    imports: [IonicModule, FormsModule, CommonModule,  BaseChartDirective],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './schedules-assignment-visualization-exam-result.page.html',
  styleUrls: ['./schedules-assignment-visualization-exam-result.page.scss'],
})
export class SchedulesAssignmentVisualizationExamResultPage implements OnInit {
topicName: string = '';
  totalTime: string = '';
  questions: any[] = [];
  answers: string[] = [];
