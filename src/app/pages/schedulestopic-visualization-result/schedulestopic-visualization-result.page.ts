...
@Component({
  selector: 'app-schedulestopic-visualization-result',
   standalone: true,
    imports: [IonicModule, FormsModule, CommonModule,  BaseChartDirective],
      schemas: [CUSTOM_ELEMENTS_SCHEMA],// ✅ ADD THIS LINE
  templateUrl: './schedulestopic-visualization-result.page.html',
  styleUrls: ['./schedulestopic-visualization-result.page.scss'],
})
export class SchedulestopicVisualizationResultPage implements OnInit {
topicName: string = '';
  totalTime: string = '';
  questions: any[] = [];
  answers: string[] = [];
